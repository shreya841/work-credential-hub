...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-D5nS8Kw4.mjs";
import { a as requestHandler, i as getResponse } from "./server-CgVhEEGw.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DqGc31b8.mjs");
