...
//#region node_modules/.nitro/vite/services/ssr/assets/employees.functions-BfzS3dm3.js
...
var regenerateEmployeeInviteLink = createServerFn({ method: "POST" }).validator(objectType({ employeeId: stringType().uuid("Invalid employee ID") })).handler(createSsrRpc("58fbdaa32d4530bd58aec9f454d5ca9a713ddc4a0c764181306c08f7fddc0859"));
...
//#endregion
export { getEmployeeByUserId as a, listEmployees as c, getEmployeeById as i, regenerateEmployeeInviteLink as l, createEmployee as n, getEmployeeInviteLink as o, deleteEmployee as r, getEmploymentHistory as s, addEmploymentHistory as t, updateEmployee as u };
