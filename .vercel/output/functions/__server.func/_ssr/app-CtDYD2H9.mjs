...
import { i as logoutUser } from "./auth.functions-D6X1b0I_.mjs";
import { t as Route } from "./app-DeIbnGKi.mjs";
import { t as Input } from "./input-BYcV5Phs.mjs";
import { t as Skeleton } from "./skeleton-7yZ1-Pcs.mjs";
import { n as useAuth, t as AuthProvider } from "./auth-provider-DIoK8pn-.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-CtDYD2H9.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sidebar, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(item.icon, { className: "h-4 w-4 shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: item.title })]
			})
		}) }, item.url)) }) })] }) })]
	});
}
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					...
					children: [
						...
						user.role === "employee" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuItem, {
							asChild: true,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/app/profile",
						...
						user.role === "super_admin" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuItem, {
							asChild: true,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
								to: "/app/settings",
								className: "w-full flex items-center cursor-pointer",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, {
				...
				children: [
					...
					(user.role === "company_admin" || user.role === "hr") && user.companyStatus !== "approved" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { className: "h-4 w-4 shrink-0 text-amber-600 dark:text-amber-400 animate-pulse" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: user.companyStatus === "rejected" ? "Your company registration has been rejected. Employee management features are disabled." : user.companyStatus === "suspended" ? "Your company workspace has been suspended. Access to workspace features is disabled." : "Your company is awaiting admin approval. Employee management features are disabled until verification is complete." })]
					}),
